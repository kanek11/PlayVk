...
void FVkStaticMeshResource::createVkResource()
{
	...
	this->vertexBuffer = CreateShared<FVkBuffer>(deviceRef, eVERTEX_BUFFER, static_cast<VkDeviceSize>(verticesSize));
	this->indexBuffer = CreateShared<FVkBuffer>(deviceRef, eINDEX_BUFFER, static_cast<VkDeviceSize>(indicesSize)); 
